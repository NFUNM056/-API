...
|对比项|百度|腾讯|
|:-|:-:|:-:|
|使用效果|包含中文普通话输入法、中文普通话搜索、英语、粤语、四川话、远场6个识别模型。|目前支持中文普通话、英语、粤语。|
|价格|每个账号月调用量有50000次的免费额度，且是按月调用次数计算费用|一句话识别免费额度为每月15000次，且实时语音识别等是按使用时长计算|
|使用文档|有给出相对应的使用文档|有给出相对应的使用文档|

 + 文字识别对比：

|对比项|百度|腾讯|
|:-|:-:|:-:|
|使用效果|都能识别出中文|都能识别出中文|
|价格|月调用次数小于等于5万次时，0.005一次，且每日有50000次免费调用量|120元/1000次，且每个月有1000次免费调用额度|
|使用文档|有给出相对应的使用文档|有给出相对应的使用文档|
...
百度AI开放平台的文字识别主要是识别中文的电子版与手写板，对于英文的识别仍然是一个缺陷。
